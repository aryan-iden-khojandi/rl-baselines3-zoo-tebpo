...
from sb3_contrib import ARS, QRDQN, TQC, TRPO, RecurrentPPO, TEBPO, TEBPO_MC, TRPO_ANALYSIS, TEBPO_MC_ANALYSIS
...
ALGOS = {
    ...
    "tebpo": TEBPO,
    "tebpo_mc": TEBPO_MC,
    "trpo_analysis": TRPO_ANALYSIS,
    "tebpo_mc_analysis": TEBPO_MC_ANALYSIS
}
